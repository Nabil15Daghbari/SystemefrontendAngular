...
class PhotosService extends __BaseService {
  static readonly savePhotoPath = '/systemrecrutement/v1/photos/{id}/{title}/{context}';
  ...
  savePhotoResponse(params: PhotosService.SavePhotoParams): __Observable<__StrictHttpResponse<{}>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/systemrecrutement/v1/photos/${params.id}/${params.title}/${params.context}`,
      __body,
      {
        headers: __headers,
        params: __params,
