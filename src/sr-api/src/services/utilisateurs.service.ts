...
class UtilisateursService extends __BaseService {
  static readonly savePath = '/systemrecrutement/v1/utilisateurs/create';
  static readonly changerMotDePassePath = '/systemrecrutement/v1/utilisateurs/update/password';
  ...
  saveResponse(body?: UtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/systemrecrutement/v1/utilisateurs/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  changerMotDePasseResponse(body?: ChangerMotDePasseUtilisateurDto): __Observable<__StrictHttpResponse<UtilisateurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/systemrecrutement/v1/utilisateurs/update/password`,
      __body,
      {
        headers: __headers,
        params: __params,
