...
class EntreprisesService extends __BaseService {
  static readonly findAllPath = '/systemrecrutement/v1/entreprises/all';
  static readonly savePath = '/systemrecrutement/v1/entreprises/create';
  static readonly deletePath = '/systemrecrutement/v1/entreprises/delete/{idEntreprise}';
  static readonly findByIdPath = '/systemrecrutement/v1/entreprises/{idEntreprise}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<EntrepriseDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/systemrecrutement/v1/entreprises/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: EntrepriseDto): __Observable<__StrictHttpResponse<EntrepriseDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/systemrecrutement/v1/entreprises/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idEntreprise: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/systemrecrutement/v1/entreprises/delete/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idEntreprise: number): __Observable<__StrictHttpResponse<EntrepriseDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/systemrecrutement/v1/entreprises/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
